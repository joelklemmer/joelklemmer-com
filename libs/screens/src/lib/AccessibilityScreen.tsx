...
export const accessibilityMetadata = generateMetadata;

export async function AccessibilityScreen() {
  const locale = (await getLocale()) as AppLocale;
  const entry = await getInstitutionalPage(locale, 'accessibility');
